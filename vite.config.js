    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          ...
          {
            src: "/icons/observatory-icon-512.png",
            sizes: "512x512",
            type: "image/png",
            purpose: "any",
          },
          {
            src: "/icons/observatory-maskable-icon-192.png",
            sizes: "192x192",
            type: "image/png",
            purpose: "maskable",
          },
          {
            src: "/icons/observatory-maskable-icon-512.png",
            sizes: "512x512",
            type: "image/png",
            purpose: "maskable",
          },
          {
            src: "/icons/observatory-icon.svg",
            sizes: "any",
            type: "image/svg+xml",
            purpose: "any",
          },
          {
            src: "/icons/observatory-maskable-icon.svg",
            sizes: "any",
            type: "image/svg+xml",
            purpose: "maskable",
          },
        ...
        shortcuts: [
          {
            ...
            url: "/record",
            icons: [{ src: "/icons/observatory-icon-192.png", sizes: "192x192" }],
          },
          {
            name: "Import Diary",
            short_name: "Import",
