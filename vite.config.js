  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: [
        ...
        "icons/observatory-20260702c-icon-16.png",
        "icons/observatory-20260702c-icon-32.png",
        "icons/observatory-20260702c-icon-48.png",
        "icons/observatory-20260702c-icon-192.png",
        "icons/observatory-20260702c-icon-512.png",
        "icons/observatory-20260702c-maskable-icon-192.png",
        "icons/observatory-20260702c-maskable-icon-512.png",
        ...
        "icons/observatory-maskable-icon-512.png",
        "icons/icon.svg",
      ...
      manifest: {
        id: "/?appId=collective-dream-observatory-20260702c",
        ...
        start_url: "/?source=pwa&icon=observatory-20260702c",
        scope: "/",
        display: "standalone",
        ...
        icons: [
          ...
          {
            src: "/icons/observatory-20260702c-icon-512.png",
            sizes: "512x512",
            type: "image/png",
            purpose: "any",
          },
          {
            src: "/icons/observatory-20260702c-maskable-icon-192.png",
            sizes: "192x192",
            type: "image/png",
            purpose: "maskable",
          },
          {
            src: "/icons/observatory-20260702c-maskable-icon-512.png",
            sizes: "512x512",
            type: "image/png",
            purpose: "maskable",
          },
          {
            src: "/icons/observatory-20260702c-icon.svg",
            sizes: "any",
            type: "image/svg+xml",
            purpose: "any",
          },
          {
            src: "/icons/observatory-20260702c-maskable-icon.svg",
            sizes: "any",
            type: "image/svg+xml",
            purpose: "maskable",
          },
        ...
        shortcuts: [
          {
            ...
            url: "/record",
            icons: [{ src: "/icons/observatory-20260702c-icon-192.png", sizes: "192x192" }],
          },
          {
            name: "Import Diary",
            short_name: "Import",
