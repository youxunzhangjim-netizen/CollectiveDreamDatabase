...
const DASHBOARD_COPY = {
  en: {
    ...
    privacyOptionPseudonym: "Share with username after review",
    privacyOptionRedacted: "Create public redacted versions after review",
    defaultPseudonymLabel: "Default username",
    defaultPseudonymPlaceholder: "Name shown for username sharing",
    ...
    bulkSensitivityRange: "Sensitivity range",
    bulkSensitivityBelow: "Sensitivity below",
    bulkSensitivityAll: "All sensitivity levels (including highest)",
    ...
    presetPseudonymTitle: "Username Archive",
    presetPseudonymDescription:
      "Let others read these dreams under your chosen username.",
    presetPseudonymPublic: "Dream text, tags, and username become public.",
  ...
  zh: {
    ...
    privacyOptionPseudonym: "審查後以用戶名公開",
    privacyOptionRedacted: "審查後建立公開節錄版",
    defaultPseudonymLabel: "預設用戶名",
    defaultPseudonymPlaceholder: "只在用戶名公開時顯示",
    ...
    bulkSensitivityRange: "敏感度範圍",
    bulkSensitivityBelow: "敏感度低於",
    bulkSensitivityAll: "所有敏感度（包含最高敏感度）",
    ...
    presetPseudonymTitle: "用戶名檔案",
    presetPseudonymDescription: "讓他人以你選擇的用戶名閱讀這些夢。",
    presetPseudonymPublic: "夢境文字、標籤與用戶名會公開。",
  ...
  es: {
    ...
    privacyOptionPseudonym: "Compartir con nombre de usuario tras revisión",
    privacyOptionRedacted: "Crear versiones públicas redactadas tras revisión",
    defaultPseudonymLabel: "Nombre de usuario predeterminado",
    defaultPseudonymPlaceholder: "Nombre mostrado al compartir con nombre de usuario",
    ...
    bulkSensitivityRange: "Rango de sensibilidad",
    bulkSensitivityBelow: "Sensibilidad menor que",
    bulkSensitivityAll: "Todos los niveles, incluido el más alto",
    ...
    modePseudonym: "Público con nombre de usuario",
    ...
    presetPseudonymTitle: "Archivo con nombre de usuario",
    presetPseudonymDescription:
      "Permite que otros lean estos sueños bajo tu nombre de usuario elegido.",
    presetPseudonymPublic: "Texto, etiquetas y nombre de usuario se vuelven públicos.",
