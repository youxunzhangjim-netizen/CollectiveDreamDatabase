const AUTH_ERROR_MESSAGES = {
  "auth/unauthorized-domain": {
    en: "Google sign-in is not available from this site yet. Try email login or guest access for now.",
    zh: "這個網站目前還不能使用 Google 登入。你可以先使用電子郵件登入或訪客模式。",
    es: "Google no está disponible desde este sitio por ahora. Usa correo o acceso invitado.",
  },
  "auth/popup-blocked": {
    en: "The Google sign-in window was blocked. Allow pop-ups for this site or try again.",
    zh: "Google 登入視窗被瀏覽器阻擋。請允許此網站的彈出視窗，或再試一次。",
    es: "El navegador bloqueó la ventana de Google. Permite ventanas emergentes o inténtalo otra vez.",
  },
  "auth/operation-not-supported-in-this-environment": {
    en: "This browser cannot open Google sign-in here. Try a normal browser tab.",
    zh: "這個瀏覽環境無法開啟 Google 登入。請改用一般瀏覽器分頁。",
    es: "Este navegador no puede abrir Google aquí. Prueba una pestaña normal.",
  },
