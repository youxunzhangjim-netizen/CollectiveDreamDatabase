...
export const RECORDER_TAG_GROUPS = [
  ...
  { category: "Entities", slugs: ["non-human", "family", "stranger", "friend", "partner", "ex-partner", "child", "baby", "teacher", "classmate", "coworker", "boss", "police", "doctor", "soldier", "crowd", "animal", "pet", "monster", "ghost", "deceased-person", "celebrity", "robot", "alien", "deity", "double"] },
