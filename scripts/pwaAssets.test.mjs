...
assert.ok(viteConfig.includes('id: "/?appId=collective-dream-observatory-20260702c"'));
assert.ok(viteConfig.includes('start_url: "/?source=pwa&icon=observatory-20260702c"'));
...
[
  ...
  "public/icons/observatory-20260702c-icon.svg",
  "public/icons/observatory-20260702c-maskable-icon.svg",
  "public/icons/observatory-20260702c-icon-16.png",
  "public/icons/observatory-20260702c-icon-32.png",
  "public/icons/observatory-20260702c-icon-48.png",
  "public/icons/observatory-20260702c-icon-192.png",
  "public/icons/observatory-20260702c-icon-512.png",
  "public/icons/observatory-20260702c-maskable-icon-192.png",
  "public/icons/observatory-20260702c-maskable-icon-512.png",
  ...
  "public/observatory-20260702c-favicon.ico",
  "public/favicon.ico",
  "public/offline.html",
  "PWA_SETUP.md",
].forEach((file) => {
