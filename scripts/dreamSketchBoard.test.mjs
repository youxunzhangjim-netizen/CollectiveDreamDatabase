...

{
  ...
  assert.match(sketchSource, /overflow-y-auto bg-black\/90/);
  assert.match(sketchSource, /lg:min-h-\[58rem\]/);
  assert.match(sketchSource, /max-w-\[118rem\]/);
  assert.match(sketchSource, /lg:grid-cols-\[minmax\(17rem,22rem\)_minmax\(0,1fr\)\]/);
  assert.match(sketchSource, /lg:min-h-\[52rem\] lg:max-h-none/);
  ...
  assert.match(sketchSource, /max-w-\[86rem\]/);
  assert.match(sketchSource, /lg:max-h-\[44rem\]/);
